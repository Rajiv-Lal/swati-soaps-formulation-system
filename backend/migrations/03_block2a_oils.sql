-- ============================================================================
-- BLOCK 2A: CARRIER OILS - Part A (3 products)
-- ============================================================================
...
INSERT INTO ingredient_regulatory (ingredient_id, einecs, cosing_ref, chemical_formula, us_approved, eu_approved, safety_notes)
VALUES (last_insert_rowid(), '283-652-0', '90990', 'Mixture of triglycerides', 1, 1, 'Generally safe. Non-comedogenic (1/5). Well-tolerated. Short shelf life - prone to oxidation.');

INSERT INTO ingredient_properties (ingredient_id, appearance, solubility, formulation_notes, sap_value, iodine_value, ins_value, hardness_coefficient, lather_coefficient)
VALUES (last_insert_rowid(), 'Golden amber to reddish-orange liquid oil', 'Oil-soluble', 'High in linoleic and linolenic acids. Rich in vitamin A. Oxidizes quickly - use antioxidants. Cold-pressed preferred.', 193, 165, 28, 0.26, 0.01);

INSERT INTO ingredient_marketing (ingredient_id, applications, benefits)
VALUES (last_insert_rowid(), 'Anti-aging serums, scar treatment, stretch mark oils, facial oils', 'Reduces scars, anti-aging, brightens skin, high in essential fatty acids, skin regeneration');
